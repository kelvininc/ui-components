...
const InfoLabelTemplateWithComponent: StoryFn<
...
const InfoLabelTemplateWithComponentHidden: StoryFn<
	ComponentProps<typeof KvInfoLabel>
> = (args) => (
	<KvInfoLabel {...args}>
		<KvTagLetter tagLetter="C" label="Change The Rapper" />
...
export const WithComponentHidden: Story = {
	args: {
		labelTitle: "DESCRIPTION",
		descriptionHeight: 0
	},
	render: InfoLabelTemplateWithComponentHidden
};
