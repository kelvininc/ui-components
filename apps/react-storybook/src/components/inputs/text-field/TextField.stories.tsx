...
export const Invalid: Story = {
	args: {
		...
		helpText: [
			"First help or instruction text goes here.",
			"Second help or instruction text goes here."
		],
...
const TextFieldLeftSlotTemplate: StoryFn<ComponentProps<typeof KvTextField>> = (
	args
) => (
