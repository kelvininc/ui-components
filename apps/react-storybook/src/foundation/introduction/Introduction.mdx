...
- **Semantic tokens** (`body[mode="..."]`): Theme-aware tokens for backgrounds, text, borders, icons, and component-specific properties (e.g., `--background-surface-default`, `--text-surface-neutral-primary`, `--border-surface-neutral-default`)
