...
export const FormStateProvider = ({ children, initialFormData, displayErrors = false }: PropsWithChildren<FormStateProviderProps>) => {
	...
	const value = useMemo(
		...
		[fieldStates, markFieldAsTouched, trackFieldChange, isFieldTouched, isFieldDirty, resetFieldState, resetAllFieldStates, displayErrors]
	);
