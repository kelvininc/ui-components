...
export const FormStateProvider = ({ children, initialFormData, isFormSubmitted = false }: FormStateProviderProps) => {
	...
	const value = useMemo(
		...
		[fieldStates, trackField, isFieldTouched, isFieldDirty, resetFieldState, resetAllFieldStates, isFormSubmitted]
	);
