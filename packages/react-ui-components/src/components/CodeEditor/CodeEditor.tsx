...
import { CodeEditor, CodeInstance, CodeRef, ICodeEditorProps, OnCodeEditorChange } from './types';
...
export const KvCodeEditor = forwardRef(function CodeEditorWithRef(props: ICodeEditorProps, ref: ForwardedRef<CodeRef>) {
