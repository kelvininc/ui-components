...
| `selectedTimeOption`        | --                           | (optional) Selected time key                                            | `ITimePickerTime \| ITimePickerTimeState`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | `undefined`                                    |
