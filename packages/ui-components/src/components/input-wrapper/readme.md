...
| ----------------------------- | ----------------- | ---------------------------------------------------------------------------- | ---------------------- | ---------------- |
| `contentHidden`               | `content-hidden`  | Defines if the content can be seen                                           | `boolean \| undefined` | `false`          |
...
| `label`                       | `label`           | Label that is shown when the component is in Default state                   | `string \| undefined`  | `undefined`      |
