...
| `headerTitle`     | `header-title`      | (optional) Defines the modal title label                                                                                                                                                | `string \| undefined`               | `undefined` |
| `showCloseButton` | `show-close-button` | (optional) Defines if the modal shows the close button                                                                                                                                  | `boolean \| undefined`              | `true`      |
| `showOverlay`     | `show-overlay`      | (optional) Defines if the modal has an overlay background                                                                                                                               | `boolean \| undefined`              | `true`      |
