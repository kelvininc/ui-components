...
| `counter`              | `counter`                 | (optional) If `true` a selection counter is displayed. Defaults to `true`.                                                                                                              | `boolean`                                                                                                                                                                                                                                                                                                                                                                      | `true`                                    |
...
| `selectionAll`         | `selection-all`           | (optional) If `true` the list has an action to select all items. Defaults to `true`.                                                                                                    | `boolean`                                                                                                                                                                                                                                                                                                                                                                      | `true`                                    |
| `selectionClearable`   | `selection-clearable`     | (optional) If `true` dropdown items can be cleared. Defaults to `true`.                                                                                                                 | `boolean`                                                                                                                                                                                                                                                                                                                                                                      | `true`                                    |
