...
| ------------------------- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| `calendarInputMaxDate`    | `calendar-input-max-date`   | (optional) Latest date, in timestamp, that can be picked or typed in the calendar; Apply is disabled for a selection after it. Defaults to 31-12-3000 23:59:59 in the selected timezone    | `number`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | `undefined`                                    |
| `calendarInputMinDate`    | `calendar-input-min-date`   | (optional) Earliest date, in timestamp, that can be picked or typed in the calendar; Apply is disabled for a selection before it. Defaults to 01-01-2018 00:00:00 in the selected timezone | `number`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | `undefined`                                    |
...
| `timezones`               | `timezones`                 | (optional) Available Timezones                                                                                                                                                             | `ITimezoneOffset[]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `getDefaultTimezones()`                        |
