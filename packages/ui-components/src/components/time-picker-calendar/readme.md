...
```html
<!-- Default -->
<kv-time-picker-calendar></kv-time-picker-calendar>

<!-- With initial date -->
<kv-time-picker-calendar initialDate="2022-08-04"></kv-time-picker-calendar>
```
...
| `mode`                      | `mode`                         | (optional) Defines if the calendar is in single date or range mode | `EAbsoluteTimePickerMode.Point \| EAbsoluteTimePickerMode.Range` | `EAbsoluteTimePickerMode.Range` |
