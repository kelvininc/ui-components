...
| ---------------------- | ------------------ | ------------------------------------------------------ | -------------------------------------------------------------- | ----------- |
| `disabledOptions`      | `disabled-options` | (optional) The options to show up as disabled          | `undefined \| { [x: string]: boolean; [x: number]: boolean; }` | `undefined` |
| `label`                | `label`            | (optional) Form field label                            | `string \| undefined`                                          | `undefined` |
| `options` _(required)_ | `options`          | (required) The configuration for the buttons to render | `IRadioListItem[]`                                             | `undefined` |
| `required`             | `required`         | (optional) Form field required                         | `boolean \| undefined`                                         | `false`     |
| `selectedOption`       | `selected-option`  | (optional) The desired selected option                 | `number \| string \| undefined`                                | `undefined` |
