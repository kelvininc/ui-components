...
export const DEFAULT_NO_DATA_AVAILABLE_ILLUSTRATION_CONFIG: IIllustrationMessage = {
	...
	description: 'There are no tags to display at the moment.'
};

export const DEFAULT_NO_RESULTS_FOUND_ILLUSTRATION_CONFIG: IIllustrationMessage = {
	illustration: EIllustrationName.NoResultsFoundDark,
	header: 'No Results Found',
	description: 'Despite our best efforts, no results were extracted.\nPlease try a new query or keyword for better results.'
};
