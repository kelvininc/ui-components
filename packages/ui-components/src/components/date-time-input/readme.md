...
| ---------------- | ------------------ | -------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| `dateFormat`     | `date-format`      | (optional) Format of the provided date                                           | `string \| undefined`                                                                                                         | `DEFAULT_DATE_FORMAT`               |
...
| `inputName`      | `input-name`       | (optional) Date time input name                                                  | `string \| undefined`                                                                                                         | `undefined`                         |
| `inputStyleType` | `input-style-type` | (optional) Specifies if the inputs should be joined together or separated        | `EDateTimeInputTypeStyle.MergedLeft \| EDateTimeInputTypeStyle.MergedRight \| EDateTimeInputTypeStyle.Separated \| undefined` | `EDateTimeInputTypeStyle.Separated` |
| `label`          | `label`            | (optional) Date time input label                                                 | `string \| undefined`                                                                                                         | `undefined`                         |
| `leftIcon`       | `left-icon`        | (optional) Input left icon                                                       | `EIconName \| undefined`                                                                                                      | `undefined`                         |
| `placeholder`    | `placeholder`      | (optional) Date time place holder                                                | `string \| undefined`                                                                                                         | `DEFAULT_PLACEHOLDER`               |
| `required`       | `required`         | (optional) Date time input required                                              | `boolean`                                                                                                                     | `false`                             |
| `rightIcon`      | `right-icon`       | (optional) Input right icon                                                      | `EIconName \| undefined`                                                                                                      | `undefined`                         |
...
| `value`          | `value`            | (optional) Date time value                                                       | `null \| string \| undefined`                                                                                                 | `''`                                |
