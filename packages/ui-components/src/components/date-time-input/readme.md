...
| `inputMaskPattern` | `input-mask-pattern` | (optional) Positional Inputmask pattern used instead of date validation when useInputMask is enabled. | `string`                                                                                                         | `undefined`                         |
