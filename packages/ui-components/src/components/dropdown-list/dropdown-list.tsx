...
export class KvDropdownList {
	...
	/** (optional) The list maximum height */
	@Prop({ reflect: true }) maxListHeight: number;
				...
				<div class="dropdown-list-container">
					{(this.searchable || this.selectionClearable) && (
						<div class="dropdown-list-header-container">
							{this.searchable && <kv-search placeholder={this.searchPlaceholder} onTextChange={this.onSearchChange}></kv-search>}
					...
					<div class="dropdown-list-items-container" style={{ maxHeight: `${this.maxListHeight}px` }}>
						<slot></slot>
					</div>
				</div>
			</Host>
