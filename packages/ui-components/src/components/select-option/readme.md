...
| ---------------------- | ------------------------- | ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------- | ----------- |
| `action`               | `action`                  | (optional) Action to display on the right side of the item                                 | `ISelectOptionAction \| undefined`                                                      | `undefined` |
| `customAttributes`     | `custom-attributes`       | (optional) Custom attributes to be applied to the option container element                 | `undefined \| { [x: string]: string; }`                                                 | `{}`        |
| `customClass`          | `custom-class`            | (optional) Custom class to apply for custom styling.                                       | `CssClassMap \| string \| string[] \| undefined`                                        | `''`        |
| `customStyle`          | `custom-style`            | (optional) Additional style to apply for custom CSS.                                       | `undefined \| { [key: string]: string \| undefined; }`                                  | `undefined` |
| `description`          | `description`             | (optional) Description of the item displayed on the right                                  | `string \| undefined`                                                                   | `undefined` |
| `disabled`             | `disabled`                | (optional) If `true` the item is disabled                                                  | `boolean \| undefined`                                                                  | `false`     |
| `heading`              | `heading`                 | (optional) If `true` the item is presented as a list heading. Default: `false`             | `boolean \| undefined`                                                                  | `false`     |
| `highlighted`          | `highlighted`             | (optional) If `true` the item is highlighted                                               | `boolean \| undefined`                                                                  | `false`     |
| `icon`                 | `icon`                    | (optional) Icon of the item displayed on the left                                          | `EIconName \| undefined`                                                                | `undefined` |
| `iconTooltipText`      | `icon-tooltip-text`       | (optional) Tooltip text to be displayed on icon hover                                      | `string \| undefined`                                                                   | `undefined` |
| `isDirty`              | `is-dirty`                | (optional) If true, a dirty dot indicator will be added to left side of the option's text. | `boolean \| undefined`                                                                  | `false`     |
...
| `rightIcon`            | `right-icon`              | (optional) Icon of the item displayed on the right                                         | `EIconName \| undefined`                                                                | `undefined` |
| `rightIconTooltipText` | `right-icon-tooltip-text` | (optional) Tooltip text to be displayed on right icon hover                                | `string \| undefined`                                                                   | `undefined` |
| `selectable`           | `selectable`              | (optional) If `false` the item is only for presenting and cannot be selected.              | `boolean \| undefined`                                                                  | `true`      |
| `selected`             | `selected`                | (optional) If `true` the item is selected                                                  | `boolean \| undefined`                                                                  | `false`     |
| `state`                | `state`                   | (optional) The toggle button state                                                         | `EToggleState.Indeterminate \| EToggleState.None \| EToggleState.Selected \| undefined` | `undefined` |
| `togglable`            | `togglable`               | (optional) If `true` the item is togglable                                                 | `boolean \| undefined`                                                                  | `false`     |
