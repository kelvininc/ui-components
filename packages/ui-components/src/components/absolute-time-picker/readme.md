...
| `headerTitle`          | `header-title`            | (optional) Title displayed on top of the component, "Custom Interval" by default or "Custom Date" in single mode. An empty title hides it | `string`                                                                                                                                   | `undefined`                     |
...
| `relativeTimeConfig`   | `relative-time-config`    | (optional) use to determine if the chart inputs have custom strings                                                                       | `IRelativeTimeInput`                                                                                                                       | `undefined`                     |
| `selectedDates`        | `selected-dates`          | (optional) Selected dates                                                                                                                 | `string[]`                                                                                                                                 | `[]`                            |
