...
| `filteredOptions`      | --                        | (optional) The object with the dropdown options filtered                                                                                                                                | `{ [x: string]: ISingleSelectDropdownOption; }`                                                                                                                                                                                                                                                                                                                                | `undefined`                                |
...
| `options`              | --                        | (optional) The object with the dropdown options                                                                                                                                         | `{ [x: string]: ISingleSelectDropdownOption; }`                                                                                                                                                                                                                                                                                                                                | `{}`                                       |
