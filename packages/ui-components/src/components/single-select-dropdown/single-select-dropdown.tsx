...
import { ISingleSelectDropdownOption, DROPDOWN_NO_DATA_AVAILABLE, ISingleSelectDropdown, ISingleSelectDropdownOptions } from './single-select-dropdown.types';
...
export class KvSingleSelectDropdown implements ISingleSelectDropdown {
	...
	@Prop({ reflect: true }) noDataAvailableLabel?: string = DROPDOWN_NO_DATA_AVAILABLE;
	...
	render() {
		return (
			<Host>
				...
				>
					<kv-dropdown-list searchable={this.searchable}>
						{isEmpty(this.options) && <kv-dropdown-list-item class="no-data" label={this.noDataAvailableLabel} value={null}></kv-dropdown-list-item>}
