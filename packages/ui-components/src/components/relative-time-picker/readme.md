...
| `customIntervalOptionEnabled` | `custom-interval-option-enabled` | (optional) Defines if the customize interval select option is available                                                                                                                 | `boolean \| undefined`                       | `true`                                       |
...
| `options`                     | `options`                        | (optional) Selectable relative time options                                                                                                                                             | `IRelativeTimePickerOption[][] \| undefined` | `DEFAULT_RELATIVE_TIME_OPTIONS_GROUPS`       |
| `selectedTimeKey`             | `selected-time-key`              | (optional) Selected time range key                                                                                                                                                      | `string \| undefined`                        | `undefined`                                  |
| `selectedTimezone`            | `selected-timezone`              | (optional) Currently selected timezone name                                                                                                                                             | `string \| undefined`                        | `undefined`                                  |
| `timezoneContentVisible`      | `timezone-content-visible`       | (optional) Determines if the input wrapper content containing the timezone is visible if true, the dropdown will be visible; if false, the content will display the timezone title      | `boolean \| undefined`                       | `false`                                      |
| `timezoneSelectionEnabled`    | `timezone-selection-enabled`     | (optional) Defines if the timezone select option is available                                                                                                                           | `boolean \| undefined`                       | `true`                                       |
| `timezones`                   | `timezones`                      | (optional) List of all selectable timezones                                                                                                                                             | `ITimezoneOffset[] \| undefined`             | `buildTimezoneByOffset(getTimezonesNames())` |
