...
| `icon`              | `icon`       | (optional) Button's left icon symbol name          | `EIconName \| undefined`                                                                                                                       | `undefined`            |
| `loading`           | `loading`    | (optional) If `true` the button is of type loading | `boolean`                                                                                                                                      | `false`                |
| `rightIcon`         | `right-icon` | (optional) Button's right icon symbol name         | `EIconName \| undefined`                                                                                                                       | `undefined`            |
| `size`              | `size`       | (optional) Button's size                           | `EComponentSize.Large \| EComponentSize.Small`                                                                                                 | `EComponentSize.Large` |
| `text`              | `text`       | (optional) Button's text                           | `string \| undefined`                                                                                                                          | `undefined`            |
