...
| `tooltipDelay`  | `tooltip-delay`  | (optional) Delay to show tooltip in milliseconds.                  | `number \| undefined`                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `DEFAULT_TOOLTIP_DELAY`  |
| `tooltipSuffix` | `tooltip-suffix` | (optional) The suffix to show on the `Copy` tooltip before copying | `string \| undefined`                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `undefined`              |
