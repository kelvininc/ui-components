...
export class KvTreeItem {
	...
	@Prop({ reflect: true }) iconState?: ETreeItemStates;
	...
	@Prop({ reflect: true }) counterState?: ETreeItemStates;
							...
							<Fragment>
								...
								>
									...
									{(this.label || this.placeholder) && (
										<div class="labels">
											<div class="title ellipsis">{this.label || this.placeholder}</div>
											{this.additionalLabel && <div class="sub-title ellipsis">{this.additionalLabel}</div>}
										</div>
									)}
