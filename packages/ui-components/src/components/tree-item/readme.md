...
| `counterState`    | `counter-state`    | (optional) Defines the state of the counter.                                                                                                                                                                                                                                                                                                                                                                                                                                          | `EBadgeState.Error \| EBadgeState.Info \| EBadgeState.None \| EBadgeState.Secondary \| EBadgeState.Success \| EBadgeState.Warning` | `undefined`                |
